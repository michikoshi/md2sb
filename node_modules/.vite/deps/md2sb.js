...
var require_remark = __commonJS({
  "node_modules/remark/index.js"(exports, module) {
    "use strict";
...
// node_modules/md2sb/dist/libs/addListItemCount.js
var require_addListItemCount = __commonJS({
  "node_modules/md2sb/dist/libs/addListItemCount.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.default = (nodeList) => nodeList.map((node, index) => {
...
// node_modules/md2sb/dist/libs/generateCodeBlock.js
var require_generateCodeBlock = __commonJS({
  "node_modules/md2sb/dist/libs/generateCodeBlock.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// node_modules/md2sb/dist/libs/compiler.js
var require_compiler = __commonJS({
  "node_modules/md2sb/dist/libs/compiler.js"(exports) {
    "use strict";
    ...
    var addListItemCount_1 = __importDefault(require_addListItemCount());
    var generateCodeBlock_1 = __importDefault(require_generateCodeBlock());
    var Compiler = class {
      constructor() {
      ...
      compile(ast, _context = {
        ...
        let result = [...ast.children || ast].map((node) => {
          var _a;
      ...
      node2SbText(node, context) {
        ...
        switch (node.type) {
          ...
          case "blockquote":
            {
              ...
              result += (depth === 1 ? "" : "\n") + quoteMark + this.compile(node.children, context).split(/\n/).join("\n" + quoteMark);
            }
            break;
          case "code":
          ...
          case "table":
            result += "table:table\n";
            result += " " + node.children.map((tableRow) => tableRow.children.map((tableCell) => {
          ...
          case "listItem": {
            ...
            result += (isChangedDepth ? "\n" : "") + " ".repeat(depth) + ("listItemCount" in node && node.listItemCount ? node.listItemCount + ". " : "") + inner + (isChangedDepth ? "" : "\n");
            break;
          }
          case "paragraph":
            result += this.compile(node.children, context);
...
// node_modules/md2sb/dist/main.js
var require_main = __commonJS({
  "node_modules/md2sb/dist/main.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    ...
    exports.default = (input) => {
      ...
      return new Promise((resolve, ng) => {
        (0, remark_1.default)().use(remark_gfm_1.default).use(compiler_1.compiler).process(mdText, (err, file) => {
          if (err)
            return ng(err);
          const result = file + "";
...
// node_modules/md2sb/dist/index.js
var require_dist2 = __commonJS({
  "node_modules/md2sb/dist/index.js"(exports) {
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    Object.defineProperty(exports, "__esModule", { value: true });
