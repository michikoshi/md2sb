...
const tags = {
    ...
    note: (context, node) => {
        var _a;
        if ((_a = context.options) === null || _a === void 0 ? void 0 : _a.evernote) {
            let content;
            const pageContext = {
                type: "page",
                options: context.options,
    ...
    tr: (context, node) => {
        ...
        if (node.children) {
            parseNodes(node.children.filter((node) => node.tagName === "td"), result);
        }
...
function collectConcatContents(node) {
    ...
    return (0, lodash_trim_1.default)(contents
        .filter((t) => {
        if (t === "")
            return false;
        return !/^\n\s+$/.test(t);
...
function reduceSimpleNodes(parent) {
    parent.children = parent.children.filter((token) => {
        ...
        token.text = (0, lodash_trim_1.default)(token.text);
        return true;
    });
    let allText = true;
    parent.children.forEach((token) => {
